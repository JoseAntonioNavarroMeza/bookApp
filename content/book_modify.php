...
<form class="" action="../content/book_modify_commit.php" method="post" enctype="multipart/form-data">
    ...
    <div class="control">
      <select class="" name="tipo">
        ...
        while ($row = mysqli_fetch_assoc($result)) {
          ?>
          <option value="<?= $row['id'] ?>" <?php if ($row['id'] == $rowBook['tipo'])
              echo 'selected' ?>><?= $row['tipo'] ?>
          </option>
        <?php } ?>
      </select>
    </div>
    ...
    <div class="control">
      <select class="" name="autor">
        ...
        while ($row2 = mysqli_fetch_assoc($resultAutores)) {
          ?>
          <option value="<?= $row2['id'] ?>" <?php if ($row2['id'] == $rowBook['autor'])
              echo 'selected' ?>>
            <?= $row2['nombre'] ?>
          </option>
        <?php } ?>
    ...
    <div class="control">
      <select class="" name="editorial">
        ...
        while ($row2 = mysqli_fetch_assoc($resultEditoriales)) {
          ?>
          <option value="<?= $row2['id'] ?>" <?php if ($row2['id'] == $rowBook['editorial'])
              echo 'selected' ?>>
            <?= $row2['editorial'] ?>
          </option>
        <?php } ?>
    ...
    <div class="control">
      <select class="" name="pais">
        ...
        while ($row3 = mysqli_fetch_assoc($resultPaises)) {
          ?>
          <option value="<?= $row3['id'] ?>" <?php if ($row3['id'] == $rowBook['pais'])
              echo 'selected' ?>>
            <?= $row3['nombre'] ?>
          </option>
        <?php } ?>
    ...
    <div class="control">
      <select class="" name="dimension">
        <?php for ($i = 1; $i < count($dimensiones); $i++) { ?>
          <option value="<?= $i ?>" <?php if ($dimensiones[$i] == $rowBook['dimensiones'])
              echo 'selected' ?>>
            <?= $dimensiones[$i] ?>
          </option>
        <?php } ?>
    ...
    <div class="control">
      <select class="" name="lenguaje">
        ...
        while ($row4 = mysqli_fetch_assoc($resultLenguajes)) {
          ?>
          <option value="<?= $row4['id'] ?>" <?php if ($row4['id'] == $rowBook['idioma'])
              echo 'selected' ?>>
            <?= $row4['lenguaje'] ?>
          </option>
        <?php } ?>
  ...
  <div class="dato">
    ...
    <div class="control">
      ...
      <img src="../resources/portadas/<?= $rowBook['imagen_portada'] ?>" alt="portada" id="imgPortada"
        name="imgPortada">
    </div>
  </div>
  <div class="dato">
    ...
    <div class="control">
      ...
      <img src="../resources/contraportadas/<?= $rowBook['imagen_contraportada'] ?>" alt="contraportada"
        id="imgContraPortada">
    </div>
  </div>
  ...
  <div class="dato">
    ...
    <div class="control" id="sobrecubierta">
      <input type="checkbox" name="sobrecubierta" <?php if ($rowBook['sobrecubierta'] == 1)
        echo 'checked' ?>>
      </div>
    </div>
    <div class="dato">
      ...
      <div class="control" class="tipo_pasta">
        <input type="radio" id="suave" name="tipo_pasta" value=0 <?php if ($rowBook['pasta_dura'] == 0)
        echo 'checked' ?>>
      </div>
    </div>
    <div class="dato">
      ...
      <div class="control" class="tipo_pasta">
        <input type="radio" id="dura" name="tipo_pasta" value=1 <?php if ($rowBook['pasta_dura'] == 1)
        echo 'checked' ?>>
      </div>
    </div>
